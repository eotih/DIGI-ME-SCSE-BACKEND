...
namespace SCSE_BACKEND.Controllers
{
    ...
    public class ManagementController : ApiController
    {
        ...
        public object XoaBaiViet(string slug)
        {
        ...
        public object ThemBaiVietEN(PostsEN1 PostsEN1)
        {
            ...
            {
                var obj = db.Posts.Where(x => x.IDPost == PostsEN1.IDPostEN).ToList().FirstOrDefault();
                if (obj.IDPost > 0)
                {
                    obj.IDCat = PostsEN1.IDCat;
                    obj.Title = PostsEN1.Title;
                    obj.Slug = ReplaceSpecialChars(PostsEN1.Title);
        ...
        [System.Web.Http.HttpDelete]
        public object XoaBaiVietEN(string slugen)
        {
